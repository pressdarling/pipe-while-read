...
| -p, --confirm | Ask for confirmation before executing each command. |
| -j, --jobs N | Run N jobs in parallel (uses zargs backend). |
| -0, --null | Expect null-terminated input (use with find -print0). |
